            ...
            >
              <CredentailsCard>
                <div className="text-foreground/90 mb-8 flex items-center">
                  <h2 className="text-muted-foreground mx-auto text-lg font-bold sm:text-2xl">Welcome to Insta Chat</h2>
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => setIsOpen(false)}
                ...
                <p className="text-foreground/80 pt-4">
                  <span className="text-red-500">Note:</span> The backend of this application is hosted on Vercel, so if
                  you notice delays in response time, that&apos;s the reason why.
                </p>
