...
const App: React.FC = (): JSX.Element => {
  return (
    <main className="text-foreground dark:bg-background bg-background selection:bg-brand/25 dark:text-foreground w-full lg:min-h-dvh">
      <ImageCropProvider>
        <Routes>
          <Route path={"/"} element={<Landing />} />
          <Route path={NAVIGATION_ROUTES.LANDING} element={<Landing />} />
